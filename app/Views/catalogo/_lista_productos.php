...
<div class="row mb-4 align-items-center">
    <div class="col-md-6 mb-3 mb-md-0">
        ...
        <div style="width: 60px; height: 4px; background: var(--turix-accent); margin-top: 10px; border-radius: 2px;">
        </div>
    </div>
    <div class="col-md-6">
        <div class="position-relative">
            <input type="search" class="form-control rounded-pill shadow-sm" placeholder="Buscar productos..." name="q"
                hx-post="<?= $searchUrl ?>" hx-trigger="input changed delay:500ms" hx-target="#productos-grid"
                hx-swap="innerHTML"
                style="padding-left: 2.5rem; padding-right: 1rem; border: 1px solid #cbd5e1; font-size: 0.95rem;">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                class="position-absolute" style="top: 50%; left: 1rem; transform: translateY(-50%); color: #64748b;">
...
<?php if (!empty($subcarpetas)): ?>
    ...
    <div class="row mb-4">
        <div class="col-12 d-flex justify-content-center flex-wrap">
            <div class="btn-group shadow-sm bg-white p-1 rounded-pill flex-wrap justify-content-center" role="group"
...
<div class="row mt-5 mb-4">
    <div class="col-12 text-center">
        <a href="<?= base_url() ?>#categorias-section"
            class="btn btn-outline-dark rounded-pill px-5 py-2 fw-bold shadow-sm"
