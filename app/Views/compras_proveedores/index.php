...
<style>
    ...
    .proveedor-autocomplete-item:first-child {
        border-radius: 10px 10px 0 0;
    }

    .proveedor-autocomplete-item:last-child {
    ...
    .prod-autocomplete-item:first-child {
        border-radius: 10px 10px 0 0;
    }

    .prod-autocomplete-item:last-child {
        border-radius: 0 0 10px 10px;
    }
    ...
    .prod-autocomplete-item .pm-highlight {
        color: #63b3ed;
        font-weight: 700;
    }
    ...
    #live-search-proveedor::placeholder {
        color: rgba(255, 255, 255, 0.65) !important;
        opacity: 1 !important;
    }

    #live-search-proveedor::-webkit-input-placeholder {
        color: rgba(255, 255, 255, 0.65) !important;
        opacity: 1 !important;
    }

    #live-search-proveedor::-moz-placeholder {
        color: rgba(255, 255, 255, 0.65) !important;
        opacity: 1 !important;
    }

    #live-search-proveedor:-ms-input-placeholder {
        color: rgba(255, 255, 255, 0.65) !important;
        opacity: 1 !important;
    }

    /* Estilos compactos para tabla de productos en compra */
    .table-input-compact {
    ...
    .table-input-compact::placeholder {
        color: rgba(255, 255, 255, 0.45) !important;
        opacity: 1 !important;
    }

    .table-input-compact::-webkit-input-placeholder {
        color: rgba(255, 255, 255, 0.45) !important;
        opacity: 1 !important;
    }
